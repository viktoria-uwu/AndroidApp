...
class SecondActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val button2 = findViewById<Button>(R.id.buttonBack)
        ...
        val animalImage = findViewById<ImageView>(R.id.image)
        val animalNameView = findViewById<TextView>(R.id.name)
        val animalDescriptionView = findViewById<TextView>(R.id.description)
